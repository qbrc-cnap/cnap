...
var getSelectInputs = function (form){

    // get all the elements that have "input_select" as an attribute
    var element_array = $(form).find("[input_select]");
...
payload = Object.assign({}, payload, getSelectInputs(analysisForm));
